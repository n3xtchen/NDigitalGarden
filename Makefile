...
serve: ## Serve Quartz locally
	export HUGO_BASEURL=http://127.0.0.1:1313 && hugo-obsidian -input=content -output=assets/indices -index -root=. && hugo server --enableGitInfo --minify

clean: ## remove the file generated by serve
	rm .hugo_build.lock
	rm static/linkmap
