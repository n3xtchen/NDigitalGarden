...
CREATE TABLE IF NOT EXISTS persons (
  ...
  name VARCHAR(30) NOT NULL COMMENT '名字（不允许为空）', -- varchar(n)  n<= 65,535
...
-- 更新数据
UPDATE persons SET nickname='nickname1' WHERE id = 1;  -- 这个时候 第一条记录会昵称会变成 nickname1，而且 modified_at 会更新到当前时间
UPDATE persons SET 
  nickname='nickname2',
  name='陈某某',
  phone='13515021100'
